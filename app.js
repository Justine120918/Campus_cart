    ...
    if(tab === "add"){
        ...
        <div class="center">
            <div class="card">
                ...
                <input id="price" placeholder="Price (PHP)">
...
function showProducts(){
    ...
    products.forEach((p,i)=>{
        list.innerHTML+=`
        <div class="product">
            <img src="${p.image}" onclick="viewImage('${p.image}')">

            <h3>${p.name}</h3>
            <p>PHP ${p.price}</p>

            <small>Remaining: ${p.stock}</small>
...
function addToCart(name,price,image){
    ...
    let product=products.find(p=>p.name===name&&p.image===image);
        ...
        <div class="card">
            ...
            ${cart.map(c=>`
                <div style="display:flex;gap:10px;align-items:center;margin:10px 0;">
                    ...
                    <div style="flex:1;">${c.name} - PHP ${c.price}</div>
                </div>
            `).join("")}
